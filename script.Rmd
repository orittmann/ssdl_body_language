...
The pose estimation data comes in `.json` format and is stored in `movenet_results`. We have two files, one for each video. Let's load the data into our environment and have a look at how it looks like.
